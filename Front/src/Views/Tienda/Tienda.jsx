...
// import { clearFilter } from "../../Redux/Reducers/gameSlice";
...
//   const [hasExecutedIf, setHasExecutedIf] = useState(false);
...
//   //   useEffect(() => {
//   //     console.log('3 correponde a la vista store')
...
//   // } else {
//     useEffect(() => {
//       if(filterSwitch === false && typeof(homeGenreFilter) === 'string') {
//       // setFilterSwitch(true);
//       console.log('1 filtros de home')
//       dispatch(getGenres()); 
...
//     }else {
//       // }else if(hasExecutedIf === true) {
//       console.log('2 no entra a filtros de home')
//       dispatch(getGenres());
//       dispatch(getGame());
//       setFilterSwitch(true);
//       };    
//     }, [dispatch, hasExecutedIf, filterSwitch]);
//   // }
...
//     const genre = '';
//     if(typeof(homeGenreFilter) === 'string'){
//       genre = homeGenreFilter;
//     }
